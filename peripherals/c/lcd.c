...
/*******************************************************************************
* Function Name: lcd_draw_block
********************************************************************************
* Summary: Prints a block centered at the coordinates set by x_start, y_start
* Returns:
*  Nothing
*******************************************************************************/
void lcd_draw_block(
...
{
	uint16_t x_start = (currX*15) + 90 + square_width/2;
	uint16_t y_start = (currY*15) + square_width/2;
  ...
  x0 = x_start - (square_width/2);
  x1 = x_start + (square_width/2);
  if( (square_width & 0x01) == 0x00)
  {
    x1--;
  }
  
  y0 = y_start  - (square_width/2);
  y1 = y_start  + (square_width/2) ;
  if( (square_width & 0x01) == 0x00)
  {
    y1--;
  }
